...
public class ByteArrayObjectDataOutput extends OutputStream implements BufferObjectDataOutput {
	...
	public ByteArrayObjectDataOutput(int size, SerializationService service, ByteOrder byteOrder) {
	...
	public String toString() {
		return "ByteArrayObjectDataOutput{" + "size=" + (buffer != null ? buffer.length : 0) + ", pos=" + pos + '}';
	}
}
